...
- (void)getCompanyOtherNoticeApiNet {
    ...
    self.getCompanyApi = [[FX_GetCompanyOtherNoticeApi alloc]initWithPage:[NSString stringWithFormat:@"%ld",(long)_leftPage] withSessionId:[GlobalData sharedInstance].selfInfo.sessionId withType:@"2"];
...
- (DiscoverNavView *)navView {
    if (_navView == nil) {
        ...
        [_navView.groundBtn2 setTitle:@"工友集" forState:UIControlStateNormal];
